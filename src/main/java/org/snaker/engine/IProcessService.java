...
public interface IProcessService {
	 ...
	 */
	void check(org.snaker.engine.entity.Process process, String idOrName);
	
	/**
	 * 保存流程定义
	 * @param process 流程定义对象
	 */
	void saveProcess(org.snaker.engine.entity.Process process);
	 ...
	 * @return List<Process> 流程定义对象集合
	 */
	List<Process> getProcesss(Page<org.snaker.engine.entity.Process> page, QueryFilter filter);
